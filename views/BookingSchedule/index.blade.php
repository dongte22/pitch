                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ route ('BookingSchedule.create') }}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo Hóa Đơn</a>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                        ...
                        @foreach( $bookingschedules as $bookingschedule)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$bookingschedule->start_time}}

                                </td>

                                <td>
                                    {{$bookingschedule->end_time}}
                                </td>
                                ...
                                <td width="80">
                                    ...
                                    <a href="{{ route('BookingSchedule.edit', $bookingschedule->id) }}" class="btn btn-primary btn-sm edit"><i class="fas fa-edit" ></i></a>

                                    <form method="post" action="{{route('BookingSchedule.destroy', $bookingschedule->id )}}">
                                        @method('DELETE')
                                        @csrf
