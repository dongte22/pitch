                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ route ('BookingDetail.create') }}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo sân mới</a>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tbody>
                        @foreach( $BookingDetail as $BookingDetails)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$BookingDetails->bookingSchedule_id}}
                                </td>

                                <td>
                                    {{$BookingDetails->pitch_id}}
                                </td>
